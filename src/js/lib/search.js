...
(function ($, window, document, undefined) {
  ...
  Plugin.prototype.configureViewFilterBehavior = function () {
    var that = this;
    this.$element
      .find('.search-form_input')
      .on('input', function () {
        var value = accentFold(this.value);
        $(that.options.scrappingClass)
          .each(function (index, element) {
            var $element = $(element);
            $element.removeClass('d-none');

            if (accentFold($element.data(that.options.scrappingValue)).search(new RegExp(value, 'gi')) === -1) {
